...
const {addAdministrator,
    ...
    deleteHealthPackage, editHealthPackage, addHealthPackage, viewAllPatients} = require('../Controllers/AdminController') //we're destructuring so we need curly braces
